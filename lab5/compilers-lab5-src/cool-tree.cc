...
Classes program_class::get_programm_classes() {
   return classes;
}
...
Symbol method_class::get_ret_type() 
{
   return return_type;
}
...
Expression static_dispatch_class::get_expr()
{
   return expr;
}

Expressions static_dispatch_class::get_expr_act()
{
   return actual;
}
...
Symbol static_dispatch_class::get_type()
{
   return type_name;
}
...
Expressions dispatch_class::get_expr_act()
{
   return actual;
}
...
Expression cond_class::get_then_expr()
{
   return then_exp;
}

Expression cond_class::get_els_expr()
{
   return else_exp;
}
...
Expression plus_class::get_first()
{
   return e1;
}

Expression plus_class::get_second()
{
   return e2;
}
...
Expression sub_class::get_first()
{
   return e1;
}

Expression sub_class::get_second()
{
   return e2;   
}
...
Expression mul_class::get_first()
{
   return e1;
}

Expression mul_class::get_second()
{
   return e2;   
}
...
Expression divide_class::get_first()
{
   return e1;
}

Expression divide_class::get_second()
{
   return e2;   
}
...
Expression lt_class::get_first()
{
   return e1;
}

Expression lt_class::get_second()
{
   return e2;
}
...
Expression eq_class::get_first()
{
   return e1;
}

Expression eq_class::get_second()
{
   return e2;   
}
...
Expression leq_class::get_first()
{
   return e1;
}

Expression leq_class::get_second()
{
   return e2;   
}
...
Expression comp_class::get_expr()
{
   return e1;
}
...
Expression isvoid_class::get_expr()
{
   return e1;
}
